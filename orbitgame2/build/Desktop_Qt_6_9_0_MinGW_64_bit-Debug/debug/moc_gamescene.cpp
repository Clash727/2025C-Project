...
template <> constexpr inline auto GameScene::qt_create_metaobjectdata<qt_meta_tag_ZN9GameSceneE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'hideJudgmentText'
        QtMocHelpers::SlotData<void()>(3, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'enableDamageTaking'
        QtMocHelpers::SlotData<void()>(4, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'handleCollectibleCollected'
        QtMocHelpers::SlotData<void(CollectibleItem *)>(5, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { 0x80000000 | 6, 7 },
        }}),
        // Slot 'handleObstacleHit'
        QtMocHelpers::SlotData<void(ObstacleItem *)>(8, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { 0x80000000 | 9, 7 },
        }}),
    };
...
void GameScene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->hideJudgmentText(); break;
        case 2: _t->enableDamageTaking(); break;
        case 3: _t->handleCollectibleCollected((*reinterpret_cast< std::add_pointer_t<CollectibleItem*>>(_a[1]))); break;
        case 4: _t->handleObstacleHit((*reinterpret_cast< std::add_pointer_t<ObstacleItem*>>(_a[1]))); break;
        default: ;
        }
    }
